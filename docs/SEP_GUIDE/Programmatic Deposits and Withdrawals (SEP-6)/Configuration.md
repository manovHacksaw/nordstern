---
title: "Stellar Docs"
source: "https://developers.stellar.org/docs/platforms/anchor-platform/sep-guide/sep6/configuration"
author:
published: 2025-12-19
created: 2026-07-01
description: "To enable SEP-6 deposits and withdraws, the Anchor Platform must be configured to do the following:"
tags:
  - "clippings"
---
...
Let's modify the `stellar.toml` file created [earlier](https://developers.stellar.org/docs/platforms/anchor-platform/sep-guide/sep1). Wallets need to know that SEP-6 functionality is supported by your business, and they also need to know all the Stellar assets you support.
...
If you do not have your own Stellar account and instead use a third party that provides you a Stellar account and memo so they can receive funds on your behalf, such as an exchange or custodian, you should omit the `distribution_account` field from your assets config file. Instead, you'll need to provide the Stellar account and memo you'd like to use to receive funds through a request to the Anchor Platform's [`request_onchain_funds`](https://developers.stellar.org/docs/platforms/anchor-platform/api-reference/platform/rpc/methods/request_onchain_funds) on a per-transaction basis.
...
The above tells the Anchor Platform to include a [JWT](https://developers.stellar.org/docs/platforms/anchor-platform/sep-guide/sep24/faq), signed with the configured secret, in the `Authorization` header of requests made to `/callbacks/<callback endpoint>` so your server can authenticate the Anchor Platform before processing requests.

See the [KYC API](https://developers.stellar.org/docs/platforms/anchor-platform/api-reference/callbacks/get-customer) and [Rates API](https://developers.stellar.org/docs/platforms/anchor-platform/api-reference/callbacks/get-rates) for details on the endpoints that must be implemented on your business server.
