...
source: "https://developers.stellar.org/docs/platforms/anchor-platform/sep-guide/sep6/getting-started"
author:
published: 2025-12-09
created: 2026-07-01
description: "This guide will walk you through configuring and integration with the Anchor Platform for the purpose of build an on & off-ramp service compatible with SEP-6, the ecosystem's standardized protocol for programmatic deposit and withdrawals."
tags:
  - "clippings"
---
...
Before continuing with this section, make sure that you have already [installed](https://developers.stellar.org/docs/platforms/anchor-platform/admin-guide/getting-started) the Anchor Platform, and configured necessary features, required by SEP-6: [SEP-1 (Stellar Info File)](https://developers.stellar.org/docs/platforms/anchor-platform/sep-guide/sep1), [SEP-10 (Stellar Authentication)](https://developers.stellar.org/docs/platforms/anchor-platform/sep-guide/sep10) and [SEP-45 (Stellar Web Authentication for contract account)](https://developers.stellar.org/docs/platforms/anchor-platform/sep-guide/sep45).
