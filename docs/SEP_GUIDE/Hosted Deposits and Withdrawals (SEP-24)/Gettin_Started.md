...
source: "https://developers.stellar.org/docs/platforms/anchor-platform/sep-guide/sep24/getting-started"
author:
published: 2025-12-09
created: 2026-07-01
description: "This guide will walk you through configuring and integrating with the Anchor Platform for the purpose of building an on & off-ramp service compatible with SEP-24, the ecosystem's standardized protocol for hosted deposits and withdrawals."
tags:
  - "clippings"
---
...
Before continuing with this section, make sure that you have already [installed](https://developers.stellar.org/docs/platforms/anchor-platform/admin-guide/getting-started) the Anchor Platform, and configured necessary features, required by SEP-24: [SEP-1 (Stellar Info File)](https://developers.stellar.org/docs/platforms/anchor-platform/sep-guide/sep1), [SEP-10 (Stellar Authentication)](https://developers.stellar.org/docs/platforms/anchor-platform/sep-guide/sep10) and [SEP-45 (Stellar Web Authentication for contract account)](https://developers.stellar.org/docs/platforms/anchor-platform/sep-guide/sep45).
