---
title: "Stellar Docs"
source: "https://developers.stellar.org/docs/platforms/anchor-platform/sep-guide/sep24/faq"
author:
published: 2025-12-09
created: 2026-07-01
description: "How To Use JWTs?"
tags:
  - "clippings"
---
### How To Use JWTs?
...
Utilize the `data.client_domain` attributes within the JWT token. In the presence of [clients](https://developers.stellar.org/docs/platforms/anchor-platform/sep-guide/sep10) configuration, the JWT token will additionally incorporate the `data.client_name` field, enabling wallet identification.