...
source: "https://developers.stellar.org/docs/platforms/anchor-platform/admin-guide/getting-started"
author:
published: 2025-12-09
created: 2026-07-01
description: "This guide will help you quickly get the Anchor Platform (TESTNET only) with a business reference running locally using Docker Compose."
tags:
  - "clippings"
---
...
> tip
> 
> For more information about configuring assets and client wallets, see the [Assets and Client Wallets](https://developers.stellar.org/docs/platforms/anchor-platform/admin-guide/assets-and-client-wallets) guide.
